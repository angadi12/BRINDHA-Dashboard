...
const Page = () => {
  ...
  const currentStatus =orderdata?.orderId?.subOrders[0]?.status; // Example
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    ...
                    <div className="bg-white rounded-sm p-6  border">
                      ...
                      {orderdata?.orderId?.subOrders[0]?.products?.map(
                        (pro, id) => (
                          <div
                            key={id}
                    ...
                    <div className="bg-white rounded-sm p-6  border">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {new Date(
                              orderdata?.orderId?.updatedAt
                            )?.toLocaleDateString("en-GB")}
                          </span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-500">Order</span>
                          <span>{orderdata?.orderId?.totalAmount}</span>
                        </div>
                        <div className="flex justify-between">
