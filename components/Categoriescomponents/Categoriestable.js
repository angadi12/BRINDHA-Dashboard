...
import { fetchAllCategories, fetchAllMeasurement } from "@/lib/Redux/Slices/masterSlice"
       ...
       {loading ? (
        ...
        <Table>
          <TableHeader className="bg-gray-50 border-y border-gray-200">
            <TableRow>
              <TableHead className="text-gray-500 text-sm font-medium">Categories</TableHead>
